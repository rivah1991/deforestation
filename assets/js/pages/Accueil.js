                    ...
                    <div className="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                        <div className="d-flex justify-content-center">
                            <div className="text-center">
                                <h2 className="mx-auto my-0 text-uppercase">Déforestation madagascar</h2>
                                <p className="text-white-50 mx-auto mt-2 mb-5">Les forêts peuvent fournir 30% de la solution pour maintenir le réchauffement climatique en dessous de 2°C
                                </p>
